...
<head>
    ...
    <title>SaticiLTE 2 | Kaydolma Sayfası</title>
...
<div class="register-box">
    <div class="register-logo">
        <a href="{{url('/')}}/assets/satici/index2.html"><b>Satici</b>LTE</a>
    </div>
    ...
    <div class="register-box-body">
        ...
        @endif
        <form action="{{url('/')}}/satici/register" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <p class="help-block">Profil resmi seçiniz.(Opsiyonel)</p>
            <div class="col-sm-10">
        ...
        <a href="{{url('/')}}/satici/login" class="text-center">Zaten kayıtlıyım</a>
    </div>
    <!-- /.form-box -->
</div>
<!-- /.register-box -->
