...
<head>
    ...
    <title>saticiLTE 2 | Log in</title>
...
<div class="login-box">
    ...
    <div class="login-box-body">
        <p class="login-box-msg">Satici paneline ulaşmak için giriş yapınız.</p>
        ...
        @endif
        <form action="{{url('/')}}/satici/login" method="post">
            @csrf
        ...
        <a href="{{url('/')}}/satici/register" class="text-center">Kaydol</a>
