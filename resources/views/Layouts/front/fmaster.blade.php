		...
		<div class="container">
			<div class="alignR">
				<div class="pull-left socialNw">
					...
					<a href="{{$data[0]->instagram}}"><span class="icon-instagram"></span></a>
				</div>
				<a class="active" href="{{url('/')}}"> <span class="icon-home"></span>Anasayfa</a>
				<a href="{{url('/')}}/user"><span class="icon-user"></span>Hesabım</a>
                @if(!(\Illuminate\Support\Facades\Auth::check()))
				<a href="{{url('/')}}/register"><span class="icon-edit"></span>Kayıt Ol</a>
                @endif
				<a href="{{url('/')}}/bizeyazin"><span class="icon-envelope"></span>Bize Yazın</a>
				<a href="{{url('/')}}/sepetim"><span class="icon-shopping-cart">Sepetim</span></a>
			</div>
		</div>
	</div>
</div>
		  ...
		  <div class="nav-collapse">
			<ul class="nav">
                <?php
                    ...
                    $bizeyazin=null;
                    $alinanmesajlar=null;
                    $gonderilenmesajlar=null;
                    $sepetim=null;
                    $siparisler=null;
                if($menu=='hakkimizda')
                        $hakkimizda='active';
                    elseif($menu=='anasayfa')
                        $home='active';
                    elseif($menu=='iletisim')
                        $iletisim='active';
                    elseif($menu=='uye')
                        $uye='active';
                    elseif($menu=='bizeyazin')
                        $bizeyazin='active';
                    elseif($menu=='sepetim')
                        $sepetim='active';
                    elseif($menu=='siparisler')
                        $siparisler='active';
                ?>
			  ...
			  <li class="{{$iletisim}}"><a href="{{url('/')}}/iletisim">İletişim</a></li>
                <li class="{{$bizeyazin}}"><a href="{{url('/')}}/bizeyazin">Bize Yazın</a></li>
                @if((\Illuminate\Support\Facades\Auth::check())  && (\Illuminate\Support\Facades\Auth::user()->role) === 'musteri')
                    <li class="{{$uye}}"><a href="{{url('/')}}/user">{{Auth::user()->name}}(Panel)</a></li>
                    <li class="{{$sepetim}}"><a href="{{url('/')}}/sepetim">Sepetim</a></li>
                    <li class="{{$siparisler}}"><a href="{{url('/')}}/siparislerim">Siparişlerim</a></li>
...
<section class="our_client">
	...
	<div class="row">
		<div class="span2">
			<a href="#"><img alt="" src="assets/front/img/1.png"></a>
		</div>
		<div class="span2">
			<a href="#"><img alt="" src="assets/front/img/2.png"></a>
		</div>
		<div class="span2">
			<a href="#"><img alt="" src="assets/front/img/3.png"></a>
		</div>
		<div class="span2">
			<a href="#"><img alt="" src="assets/front/img/4.png"></a>
		</div>
		<div class="span2">
			<a href="#"><img alt="" src="assets/front/img/5.png"></a>
		</div>
		<div class="span2">
			<a href="#"><img alt="" src="assets/front/img/6.png"></a>
		</div>
	</div>
</section>
