...
<head>
    ...
    <link rel="stylesheet" href="{{url('/')}}/assets/satici/css/skins/_all-skins.min.css">
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="../../index2.html" class="logo">
            ...
            <span class="logo-lg"><b>Satici</b></span>
        </a>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                <div class="pull-right">
                                    <a href="{{url('/')}}/satici/logout" class="btn btn-default btn-flat">Çıkış Yap</a>
                                </div>
                            </li>
                        </ul>
                    </li>
...
@include('layouts.satici.ssidebar')
...
<!-- SlimScroll -->
<script src="{{url('/')}}/assets/satici/bower_components/jquery-slimscroll/jquery.slimscroll.min.js"></script>
<!-- FastClick -->
<script src="{{url('/')}}/assets/satici/bower_components/fastclick/lib/fastclick.js"></script>
<!-- AdminLTE App -->
<script src="{{url('/')}}/assets/satici/js/adminlte.min.js"></script>
<!-- AdminLTE for demo purposes -->
<script src="{{url('/')}}/assets/satici/js/demo.js"></script>
<script>
